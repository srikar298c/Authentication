        ...
        <>
            <main
                ...
                <div className="space-y-6">
                    <h1 className={cn("text-6xl font semi-bold text-white drop-shadow-md", font.className)}> Authentication</h1>
                    <p className="text-white">Level-6 Authentication</p>
                    <div><Button variant="secondary" size={"lg"}>Sign Up</Button></div>
                </div>
            </main>
